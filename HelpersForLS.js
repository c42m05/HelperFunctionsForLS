// Helper Utils for LS  © 2025 by c4205M(c42m05) is licensed under CC BY 4.0. To view a copy of this license, visit https://creativecommons.org/licenses/by/4.0/
 ...
 * @returns {Object.<string, any>} An object mapping component short names (without "Component." or "Physics." prefixes) and "Object" to the created components and scene object.
 *
 * @example
 * // Creates a new scene object named "MyObject" under root,
 * // with "Component.RenderMeshVisual" and "Physics.RigidBody" components.
 * const components = createSceneComponent(root, "MyObject", ["Component.RenderMeshVisual", "Physics.RigidBody"]);
 ...
 */
function createSceneComponent(root, objectName, componentNames, override = false) {
